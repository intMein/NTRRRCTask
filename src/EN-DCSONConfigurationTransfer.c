...
asn_TYPE_member_t asn_MBR_EN_DCSONConfigurationTransfer_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct EN_DCSONConfigurationTransfer, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_7327P54,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_EN_DCSONConfigurationTransfer_specs_1 = {
