 ...
 */
asn_per_constraints_t asn_PER_type_PendingDataIndication_constr_1 CC_NOTUSED = {
...
const asn_INTEGER_specifics_t asn_SPC_PendingDataIndication_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_PendingDataIndication = {
	...
	sizeof(asn_DEF_PendingDataIndication_tags_1)
		/sizeof(asn_DEF_PendingDataIndication_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_PendingDataIndication_constr_1, NativeEnumerated_constraint },
