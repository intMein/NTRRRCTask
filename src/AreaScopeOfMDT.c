...
asn_TYPE_member_t asn_MBR_AreaScopeOfMDT_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct AreaScopeOfMDT, choice.cellBased),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AreaScopeOfMDT, choice.tABased),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct AreaScopeOfMDT, choice.tAIBased),
