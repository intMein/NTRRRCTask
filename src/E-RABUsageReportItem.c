...
asn_TYPE_member_t asn_MBR_E_RABUsageReportItem_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct E_RABUsageReportItem, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_ProtocolExtensionContainer_7327P62,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_E_RABUsageReportItem_specs_1 = {
